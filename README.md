...
### Python
  ...
  * [Проект по олимпиаде «Траектория будушего 2025» в дисциплине «Проектирование нейросети на Python».](https://github.com/VitalinaZlo/Trajectory-future2024_Weather_predictor) Проект предназначен для предсказания погоды по месяцам на основе данных предыдущих лет в интерфейсе, обеспечивающем обучение модели, настройку параметров и выбора года предсказания.
